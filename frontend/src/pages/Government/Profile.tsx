    ...
    <main className="min-h-screen text-(--color-dark-teal) space-y-6">
      <div className="mx-auto max-w-4xl rounded-4xl border border-[rgba(53,98,103,0.16)] bg-white p-6 shadow-[0_20px_70px_rgba(15,23,42,0.08)] sm:p-8">
        ...
        <form onSubmit={handleSave} className="mt-8 space-y-6">
          ...
          <div className="flex flex-col items-center sm:flex-row gap-6 p-6 rounded-3xl border border-[rgba(53,98,103,0.14)] bg-(--color-soft-mint)/30">
            <div className="relative">
              ...
              />
              <label className="absolute bottom-0 right-0 rounded-full bg-(--color-ocean) p-2 text-white shadow-sm cursor-pointer hover:bg-(--color-deep-ocean)">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <h2 className="text-xl font-bold text-(--color-deep-ocean)">{profile.name}</h2>
                <BadgeCheck className="h-5 w-5 text-(--color-ocean)" />
              </div>
              <p className="text-xs font-bold uppercase tracking-wider text-(--color-ocean)">
                {profile.designation}
              </p>
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            ...
            <div>
              ...
              <div className="relative">
                <ShieldCheck className="absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-(--color-medium-teal)" />
                <input
                  type="text"
            ...
            <div>
              ...
              <div className="relative">
                <Building2 className="absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-(--color-medium-teal)" />
                <input
                  type="text"
            ...
            <div>
              ...
              <div className="relative">
                <BadgeCheck className="absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-(--color-medium-teal)" />
                <input
                  type="text"
          ...
          <div className="pt-2">
            <button
              type="submit"
              disabled={saving}
              className="flex items-center gap-2 rounded-2xl bg-(--color-ocean) px-6 py-3 text-xs font-bold text-white transition hover:bg-(--color-deep-ocean) disabled:opacity-50"
            >
