...
const INITIAL_GOVERNMENT_ALERTS: GovernmentAlert[] = [
  ...
  {
    id: "ALT-202",
    type: "New missing-person report",
    title: "Missing person report requires verification",
    description: "New report submitted for Maya Chen last seen near Pier 7.",
    location: "Puri",
    priority: "Critical",
    ...
    status: "Pending Review",
    actionLabel: "Review",
    targetRoute: "/government/missing",
  },
  {
    id: "ALT-203",
    type: "Rescue request",
