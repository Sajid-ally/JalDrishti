              ...
              <Popup>
                {popupContent ?? <div style={{ minWidth: "160px", fontFamily: "inherit" }}>
                  <p style={{ fontWeight: 700, fontSize: "0.85rem", marginBottom: "0.25rem" }}>
                    {hazard.title || HAZARD_LABELS[hazard.hazardType]}
                  </p>
                  {hazard.reportId && (
                    <p style={{ fontFamily: "monospace", fontWeight: 700, fontSize: "0.72rem", color: "#0f766e", marginBottom: "0.25rem" }}>
                      {hazard.reportId}
                    </p>
                  )}
                  {hazard.placeName && (
                  ...
                  {hazard.description && (
                    <p style={{ fontSize: "0.76rem", color: "#475569", marginTop: "0.4rem", lineHeight: 1.35 }}>
                      {hazard.description}
                    </p>
                  )}
                </div>}
